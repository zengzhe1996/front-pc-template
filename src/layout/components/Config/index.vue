...
import { useDarkHooks } from '@/utils/useDark';
import { useConfig } from '@/store/modules/layout.js';
import usePermission from '@/store/modules/permission';
import { STORE_CONFIG, BEFORE_RESIZE_LAYOUT } from '@/store/constant/cacheKey.js';
...
<template>
  <div class="layout-config-drawer">
    <el-drawer size="310px" title="布局配置" :model-value="configStore.layout.showDrawer" @close="onCloseDrawer">
          ...
          <div class="layout-mode-styles-box">
            ...
            <div class="layout-config-global">
              ...
              <el-form-item label="移动端">
                <el-switch @change="onCommitState($event, 'isMobile')" :model-value="configStore.layout.isMobile">
